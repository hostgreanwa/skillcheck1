...
function Bottom() {
    return (
        ...
        <div className='last-bottom-section'>
            <svg className='wave' xmlns="http://www.w3.org/2000/svg" width="1440" height="330" viewBox="0 0 1440 330" fill="none">
            ...
            <div className='bottom-text'>Design By Rauliqbal But Coding By Me</div>
        </div>
    )
